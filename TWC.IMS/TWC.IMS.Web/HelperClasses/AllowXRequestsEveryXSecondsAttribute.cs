...
namespace TWC.IMS.Web.HelperClasses
{
    ...
    // Source: https://github.com/johnstaveley/SecurityEssentials/blob/master/SecurityEssentials/Core/Attributes/AllowXRequestsEveryXSeconds.cs
    /// <summary>
        ...
        public override void OnActionExecuting(ActionExecutingContext c)
        {
            ...
            if (!allowExecute)
            {
                if (string.IsNullOrEmpty(Message))
                    Message = string.Format("You have performed this action more than {0} times in the last {1} seconds.", Requests.ToString(CultureInfo.CurrentCulture), Seconds.ToString(CultureInfo.CurrentCulture));
