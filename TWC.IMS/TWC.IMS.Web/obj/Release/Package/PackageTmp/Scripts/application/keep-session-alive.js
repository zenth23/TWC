...
$(function () {
    ...
    //_clientAlive = 0;
    localStorage.setItem(_projectmold_ksa_clientAlive, 0);
    ...
    $('#btnSessionExpiredOK').on('click', () => {
        ...
        pingServer('hbeat');
        //_hold = 0;
        localStorage.setItem(_projectmold_ksa_hold, 0);
    });
});

// TODO: change these values per project
var _projectmold_ksa_renew = "_projectmold_ksa_renew";
var _projectmold_ksa_hold = "_projectmold_ksa_hold";
var _projectmold_ksa_clientAlive = "_projectmold_ksa_clientAlive";
//--------------------------------------------------
...
localStorage.setItem(_projectmold_ksa_renew, _renew);
localStorage.setItem(_projectmold_ksa_hold, _hold);

function heartBeat() {
    _hBeat = setTimeout(() => {
        //console.log('heartBeat');
        _clientAlive = localStorage.getItem(_projectmold_ksa_clientAlive);
        if (_clientAlive == 0) {
            //_renew = 0;
            //_hold = 1;
            localStorage.setItem(_projectmold_ksa_renew, 0);
            localStorage.setItem(_projectmold_ksa_hold, 1);
            ...
            setTimeout(() => {
                _renew = localStorage.getItem(_projectmold_ksa_renew);
...
function checkAlive() {
    ...
    $('body').on('mousemove keydown', () => {
        _hold = localStorage.getItem(_projectmold_ksa_hold);
        if (_hold == 0) {
            //_clientAlive = 1;
            localStorage.setItem(_projectmold_ksa_clientAlive, 1);

            //_renew = 1;
            localStorage.setItem(_projectmold_ksa_renew, 1);
        }
    });
}
