productmaster = {
    initialize: function () {
        ...
        $("body").on("focusout, blur" 
                    , "#product_type" 
                    , productmaster.editor.events.changeValidationMessage);
    ...
    common: {
        ...
        onEdit: function (e) {
            ...
            $(uButton).click(function (e) {
                setTimeout(function () {
                    var fields = ["product_type"]
                    productmaster.editor.events.changeAllValidationMessage(fields);
                }, 10);
        ...
        onRequestEnd: function (e) {
            if (e.type == "create") {
                if (e.response.Success == false) {
                    ...
                    var grid = $("#gridProductMaster").data("kendoGrid");
                    grid.one("dataBinding", function (args) {
                        args.preventDefault();
                        kendo.ui.progress($("#gridProductMaster"), false);
                    });
                } else {
