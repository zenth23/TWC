...
{
    public class Inventory_Entry : IDisposable
    {
      
        private DL.Inventory_Entry _dlObj = null;
        private string _username;


        public Inventory_Entry(string username)
        {
        ...
        public Task<IEnumerable<Models.Inventory_Entry>> GetListAsync(params string[] includeEntities)
        {
            ...
            try
            {
                using (_dlObj = new DL.Inventory_Entry(username))
                {
        ...
        public Task<Models.Inventory_Entry> GetByKeyAsync(Guid uniqueKey, params string[] includeEntities)
        {
            string username = _username;
            try
            {
        ...
        public Task<Models.Inventory_Entry> GetAsync(int id, params string[] includeEntities)
        {
            string username = _username;
            try
            {
