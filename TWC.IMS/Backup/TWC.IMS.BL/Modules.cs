...
namespace TWC.IMS.BL
{
    ...
    {
        private DL.Modules _dlObj = null;
        ...
        public Task<IEnumerable<Models.Module>> GetListAsync()
        {
            string username = _username;
            try
            {
                using (_dlObj = new DL.Modules(username))
                {
        ...
        public Task<Models.Module> GetAsync(int id)
        {
            string username = _username;
            try
            {
        ...
        public Task<Models.Module> GetAsync(Guid uniqueKey)
        {
            string username = _username;
            try
            {
        ...
        public Task<Models.Module> GetAsync(string name)
        {
            string username = _username;
            try
            {
        ...
        public Task<int> UpdateAsync(Models.Module obj)
        {
            string username = _username;
            try
            {
