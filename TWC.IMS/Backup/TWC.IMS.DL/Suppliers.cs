...
namespace TWC.IMS.DL
{
    public class Suppliers : IDisposable
    {
        ...
        public async Task<IEnumerable<Models.Supplier>> GetListAsync(params string[] includeEntities)
        {
            try
            {
                using (var db = new Models.Entities())
                {
                    var query = (DbQuery<Models.Supplier>)db.Set<Models.Supplier>();
        ...
        public async Task<Models.Supplier> GetAsync(int id ,params string[] includeEntities)
        {
            try
            {
                using (var db = new Models.Entities())
