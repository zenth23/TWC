...
namespace TWC.IMS.BL
{
    public class producttypes : IDisposable
    {
        ...
        private DL.ProductType _dlObj = null;
        private string _username;


        public producttypes(string username)
        {
        ...
        public Task<IEnumerable<Models.ProductType>> GetListAsync(params string[] includeEntities)
        {
            string username = _username;
            try
            {
                using (_dlObj = new DL.ProductType(username))
                {
        ...
        public Task<Models.ProductType> GetAsync(int id ,params string[] includeEntities)
        {
            string username = _username;
            try
            {
        ...
        public async Task<Models.ProductType> GetByNameAsync(string SalesTypeName)
        {
            string username = _username;
            try
            {
