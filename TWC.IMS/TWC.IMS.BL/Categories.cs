...
namespace TWC.IMS.BL
{
    public class Categories : IDisposable
    {
        ...
        private DL.Categories _dlObj = null;
        ...
        public Task<IEnumerable<Models.Category>> GetListAsync(params string[] includeEntities)
        {
            string username = _username;
            try
            {
                using (_dlObj = new DL.Categories(username))
                {
        ...
        public Task<Models.Category> GetAsync(int id ,params string[] includeEntities)
        {
            string username = _username;
            try
            {
