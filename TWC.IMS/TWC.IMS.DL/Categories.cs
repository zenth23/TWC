...
namespace TWC.IMS.DL
{
    public class Categories : IDisposable
    {
        ...
        public async Task<IEnumerable<Models.Category>> GetListAsync(params string[] includeEntities)
        {
            try
            {
                using (var db = new Models.Entities())
                {
                    var query = (DbQuery<Models.Category>)db.Set<Models.Category>();
        ...
        public async Task<Models.Category> GetAsync(int id ,params string[] includeEntities)
        {
            try
            {
                using (var db = new Models.Entities())
